...
갤러리 관리자(무급 노예)를 위한 여러 편의 기능을 제공합니다. 글댓비 확인, 다중 선택, 빠른 삭제, 갱차 조회 등의 기능이 포함되어 있습니다.
...
| 글댓비 표시          | 글댓비를 표시합니다. (1시간마다 갱신, 새 글 작성 시에만 조회)                        | 꺼짐  |
| 깡계 알림           | 글댓합이 설정한 값 이하일 때 강조 표시합니다. (0이면 비활성화, 범위: 0 ~ 5000)         | 0   |
| Ctrl로 삭제        | Ctrl키를 누른 상태로 게시글을 클릭해 삭제합니다.                                | 꺼짐  |
| 갱차 조회           | 갱신 차단 여부를 조회합니다.                                             | 꺼짐  |
| GIF 조작 기능 활성화   | GIF를 제어할 수 있는 기능을 활성화합니다.                                    | 꺼짐  |
...
- 갱차 정보는 [DC-Modtools](https://dcmodtools.pages.dev)에서 가져옵니다.