...
페이지 내의 이미지를 일시적으로 숨길 수 있는 기능을 제공합니다. 공공장소나 회사 등에서 불편함 없이 디시인사이드를 이용할 수 있게 해줍니다.

## 기능

페이지 내에 표시되는 모든 이미지를 비활성화하며, 이미지 보기/숨기기 토글 버튼을 제공하여 사용자가 필요에 따라 이미지를 쉽게 제어할 수 있습니다.

## 설정 옵션

이 모듈은 별도의 설정 옵션을 제공하지 않으며, 활성화/비활성화만 가능합니다. 기본적으로 비활성화되어 있습니다.
