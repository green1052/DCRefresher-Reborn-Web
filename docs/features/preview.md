...
게시글을 페이지 이동 없이 미리 볼 수 있는 기능을 제공합니다. 게시글 목록에서 오른쪽 클릭으로 팝업 창을 열어 내용과 댓글을 확인할 수 있으며, 추천/비추천, 댓글 작성 등 다양한 상호작용이 가능합니다. 마우스를 올려 간단히 툴팁으로 내용을 미리볼 수도 있습니다.
...
| 툴팁 미리보기 딜레이                          | 툴팁 미리보기가 나타나기까지의 시간을 설정합니다. (0 ~ 1000ms)               | 0ms     |
...
| 기본 마우스 오른쪽 클릭 딜레이                    | 마우스 오른쪽 버튼을 해당 밀리초 이상 눌러 뗄 때 기본 우클릭 메뉴가 나오게 합니다. (200 ~ 2000ms) | 300ms   |
...
| 댓글 자동 새로고침 주기                        | 위의 옵션이 켜져있을 시 댓글을 새로고침할 주기를 설정합니다. (3000 ~ 20000ms)   | 10000ms |
...
| 관리 패널 > 차단 프리셋 > 식별 코드 차단 시 IP 동시 차단 | 식별 코드 차단 시 IP도 동시에 차단합니다.                              | 꺼짐      |
...
3. 미리보기 창에서 추천/비추천, 댓글 작성 등 다양한 상호작용이 가능합니다.
