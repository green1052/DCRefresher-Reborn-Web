...
게시글이나 댓글에 첨부된 이미지의 출처를 검색할 수 있는 기능을 제공합니다.

## 기능

이미지를 우클릭하여 SauceNAO 검색 엔진을 통해 해당 이미지의 원본 출처, 비슷한 이미지, 또는 동일한 이미지가 사용된 다른 웹사이트를 찾을 수 있습니다.
...
3. 새 탭이 열리며 SauceNAO 검색 결과가 표시됩니다.
